...
function showRaport() {
    ...
    $query_result = $db_connection->query("SELECT project_id, SUM(hours) suma, SUM(extra_hours) suma_extra, SUM(hours) + SUM(extra_hours) suma_total FROM timesheet where emp_id='". $_POST['emp_id'] ."' AND date
