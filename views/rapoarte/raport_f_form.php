...
function displayForm(){
	...
	$r = '</br><h3>Afiseaza clientii din perioada introdusa</h3></br>';

	$r .= '<form method = "post" action = "raport_f.php" name="raport_f">';
    
    $r .= '<label style="display: inline-block; width: 150px; text-align: left; margin-left: 20px;">Incepand cu </label>';
