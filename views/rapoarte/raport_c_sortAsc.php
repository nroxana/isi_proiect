...
function showRaportAsc() {
	...
	$query_result = $db_connection->query("SELECT emp_id, project_id, SUM(hours) suma, SUM(extra_hours) suma_extra, SUM(hours) + SUM(extra_hours) suma_total 
        ...
        $r .= '         <th style="text-align:center" width="100	 align="center">Ore Lucrate</td>';
        $r .= '         <th style="text-align:center" width="100	 align="center">Ore Lucrate Extra</td>';
        $r .= '         <th style="text-align:center" width="100	 align="center">Ore Lucrate Total</td>';
        $r .= '    </tr>';
		$r .= '</thead>';
